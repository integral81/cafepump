...
const DEOKSO_CAFES = [
    ...
    { name: '버즈커피 (Buzz Coffee)', address: '경기 남양주시 와부읍 덕소로116번길 20', lat: 37.5841, lng: 127.2095, outlet_density: 4, noise_level: 2, eyesight_pressure: 1, killing_comment: '단아커피의 명성을 잇는 곳. 아늑한 분위기와 훌륭한 커피로 카공족에게 사랑받는 공간입니다.' },
    { name: '젠틀콩 (젠틀콩 베이커리카페)', address: '경기 남양주시 와부읍 덕소로116번길 20', lat: 37.5835, lng: 127.2085, outlet_density: 3, noise_level: 2, eyesight_pressure: 1, killing_comment: '베이커리가 훌륭한 덕소 명당. 작업하며 당 충전하기 좋습니다.' },
    { name: '소보심 (소보심 덕소점)', address: '경기 남양주시 와부읍 덕소리 524-5', lat: 37.5830, lng: 127.2080, outlet_density: 3, noise_level: 3, eyesight_pressure: 1, killing_comment: '소보로 맛집이자 아늑한 분위기. 집중해서 작업하기 좋은 공간입니다.' },
